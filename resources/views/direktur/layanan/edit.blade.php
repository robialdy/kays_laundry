                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="no_layanan" class="form-control" name="no_layanan" value="{{ $layanan->no_layanan }}" disabled>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="nama_layanan" class="form-control"
                                                placeholder="Masukan Nama Layanan" name="nama_layanan" value="{{ old('nama_layanan', $layanan->nama_layanan) }}">
                                                @error('nama_layanan')
