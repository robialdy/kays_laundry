            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form action="{{ route('paket.store') }}" class="form" method="post">
                                @csrf
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="layanan" id="layanan" class="form-control">
                                                ...
                                                @foreach ($layanans as $layanan)
                                                    <option value="{{ $layanan->id }}" @if (old('layanan') == $layanan->id) selected @endif>{{ $layanan->nama_layanan }}</option>
                                                @endforeach
                                            </select>
                                                @error('layanan')
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <select name="satuan" id="satuan" class="form-control">
                                                ...
                                                <option value="Satuan" @if (old('satuan') == 'Satuan') selected @endif>Satuan</option>
                                                <option value="Kiloan" @if (old('satuan') == 'Kiloan') selected @endif>Kiloan</option>
                                            </select>
                                                @error('satuan')
                                                    <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="barang" class="form-control"
                                                placeholder="Masukan Nama Barang" name="barang" value="{{ old('barang') }}">
                                                @error('barang')
                                                    <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                        </div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="nama_paket" class="form-control"
                                                placeholder="Masukan Nama Paket" name="nama_paket" value="{{ old('nama_paket') }}">
                                                @error('nama_paket')
                                                    <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                        </div>
