                        ...
                        <div class="card-body">
                            <form action="{{ route('user.store') }}" method="post">
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="number" id="no_hp" class="form-control"
                                                    placeholder="Masukan No Hp" name="no_hp" value="{{ old('no_hp') }}">
                                            </div>
                                                @error('no_hp')
                                                    <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="kota">Kota Tempat Tinggal <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <select name="role" id="role" class="form-control">
                                                ...
                                                <option value="OC">Operator Cabang</option>
                                                <option value="PC">Pelaksana Cabang</option>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="alamat" id="alamat" class="form-control" placeholder="Masukan Alamat Cabang">{{ old('alamat') }}</textarea>
                                                @error('alamat')
                                                    <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                        </div>
